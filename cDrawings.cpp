...
int DrawCenteredString(char* String, int x, int y, int r, int g, int b, ID3DXFont* ifont)
{
	RECT Center = { 0, 0, 0, 0 }, Position = { x, y, 0, 0 };
    ifont->DrawTextA(0, String, (INT)strlen(String), &Center, DT_CALCRECT, NULL);

    Position.left = (LONG)x - (Center.right / 2);
    Position.top = (LONG)y;

	ifont->DrawTextA(0, String, strlen(String), &Position, DT_NOCLIP, D3DCOLOR_ARGB(255, r, g, b));
	return 0;
}
...
int DrawShadowStringCentered(char* String, int x, int y, int r, int g, int b, int rr, int gg, int bb, ID3DXFont* ifont)
{
    RECT Center = { 0, 0, 0, 0 }, Position = { x, y, 0, 0 };
    ifont->DrawTextA(0, String, (INT)strlen(String), &Center, DT_CALCRECT, NULL);

    x = (LONG)x - (Center.right / 2);
    y = (LONG)y;
	...
	Fonts3.left = x;
	Fonts3.top = y-1;
	ifont->DrawTextA(0, String, strlen(String), &Fonts3, DT_NOCLIP , D3DCOLOR_ARGB(255, rr, gg, bb));
	ifont->DrawTextA(0, String, strlen(String), &Fonts2, DT_NOCLIP, D3DCOLOR_ARGB(255, rr, gg, bb));
	ifont->DrawTextA(0, String, strlen(String), &Fonts1, DT_NOCLIP, D3DCOLOR_ARGB(255, rr, gg, bb));
	ifont->DrawTextA(0, String, strlen(String), &Fonts, DT_NOCLIP, D3DCOLOR_ARGB(255, rr, gg, bb));
	ifont->DrawTextA(0, String, strlen(String), &Font, DT_NOCLIP, D3DCOLOR_ARGB(255, r, g, b));
	return 0;
}
